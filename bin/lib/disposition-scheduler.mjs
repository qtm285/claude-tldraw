...
//
// Design notes:
//  - Per-agent scoped: each agent has at most one pending timer. Skip messaging
//    agent X cancels only X's countdown (TAXONOMY H / CLAUDE.md "when I am in
//    the room, you shut the fuck up" — but only for the agent he's in the room
//    WITH).

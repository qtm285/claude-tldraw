...
export const LOOSE_END_REPORT_MSG = `Loose-end check: before you wait for Skip, list the next unresolved action you can do yourself. If your message says "needs X", "unless X", "not verified", "not deployed", or "condition", either do X now, assign it, or state the true authority boundary. Do not make Skip say "go do that work."`

...
// VERIFY 2: approve Prop 8.2 from the ordinary type list → it and its cascade
// (Prop 8.3) clear, while the independent Prop 7.1 root remains.
await page.locator('.fleet-inbox-node-direct', { hasText: 'Proposition 8.2' }).locator('.fleet-inbox-node-approve').click()
await page.waitForTimeout(800)
const after = await readRows()
log('VERIFY 2 (approve-upstream-clears-downstream, from list):', JSON.stringify(after, null, 1))

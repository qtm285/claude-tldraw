...
#   1. Push a new vX.Y.Z tag to github.com/tlda-app/tlda
#   2. The release workflow creates the tarball
#   3. Download the tarball, compute sha256:
#      curl -sL https://github.com/tlda-app/tlda/releases/download/vX.Y.Z/tlda-vX.Y.Z.tar.gz | shasum -a 256
#   4. Update url + sha256 below
#   5. Commit to homebrew-tlda

class Tlda < Formula
  desc "Paper review and annotation system for LaTeX papers"
  homepage "https://github.com/tlda-app/tlda"
  url "https://github.com/tlda-app/tlda/releases/download/v0.3.1/tlda-v0.3.1.tar.gz"

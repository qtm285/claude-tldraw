...
**⚠️ built and finished, but not on your box — 3 rows carry this**: the scrollback work, the place
stack, and token gating, all merged after the 06:04 deploy. From where you sit it is indistinguishable from not-done. · **✓? built and on your box, and
...
Your box runs `2e763c010`, read from `/api/build-info` at 08:55 EDT; `main` is `7a384e136`, 52 ahead —

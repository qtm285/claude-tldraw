...
function LayoutIcon({ id, size = 20 }: { id: LayoutId; size?: number }) {
  ...
  const layouts: Record<LayoutId, JSX.Element> = {
    '3col': (
      // [agents/search] [chat] [chat+docview]
      <>
        <rect x={0} y={0} width={s*0.22} height={s*0.55} rx={r} fill={ap} />
        <rect x={0} y={s*0.55+g} width={s*0.22} height={s*0.45-g} rx={r} fill={sr} />
        <rect x={s*0.22+g} y={0} width={s*0.38-g} height={s} rx={r} fill={ch} />
        <rect x={s*0.6+g} y={0} width={s*0.4-g} height={s*0.7} rx={r} fill={ch} />
        <rect x={s*0.6+g} y={s*0.7+g} width={s*0.4-g} height={s*0.3-g} rx={r} fill={dv} />
      </>
    ),
    '2col': (
      ...
      <>
        <rect x={0} y={0} width={s*0.22} height={s*0.55} rx={r} fill={ap} />
        <rect x={0} y={s*0.55+g} width={s*0.22} height={s*0.45-g} rx={r} fill={sr} />
        <rect x={s*0.22+g} y={0} width={s*0.35-g} height={s} rx={r} fill={ch} />
        <rect x={s*0.65+g} y={0} width={s*0.35-g} height={s} rx={r} fill={ch} />
      </>
    ),
    'wide': (
      // [agents/search] [wide chat]
      <>
        <rect x={0} y={0} width={s*0.22} height={s*0.55} rx={r} fill={ap} />
        <rect x={0} y={s*0.55+g} width={s*0.22} height={s*0.45-g} rx={r} fill={sr} />
        <rect x={s*0.22+g} y={0} width={s*0.78-g} height={s} rx={r} fill={ch} />
      </>
    ),
    'grid': (
      // [agents/search] [2x2 chats]
      <>
        <rect x={0} y={0} width={s*0.22} height={s*0.55} rx={r} fill={ap} />
        <rect x={0} y={s*0.55+g} width={s*0.22} height={s*0.45-g} rx={r} fill={sr} />
        <rect x={s*0.22+g} y={0} width={s*0.38-g} height={s*0.5-g/2} rx={r} fill={ch} />
        <rect x={s*0.6+g} y={0} width={s*0.4-g} height={s*0.5-g/2} rx={r} fill={ch} />
        <rect x={s*0.22+g} y={s*0.5+g/2} width={s*0.38-g} height={s*0.5-g/2} rx={r} fill={ch} />
        <rect x={s*0.6+g} y={s*0.5+g/2} width={s*0.4-g} height={s*0.5-g/2} rx={r} fill={ch} />
      </>
    ),
  }

...
export function FleetHUD({
  ...
  useEffect(() => {
    ...
    const isInsideFleetShape = (clientX: number, clientY: number) => {
      ...
      return !!target.closest('[data-shape-type="fleet-chat"], [data-shape-type="fleet-agents"], [data-shape-type="fleet-search"], [data-shape-type="fleet-inbox"], [data-shape-type="fleet-docview"], [data-shape-type="fleet-reaper"]')
    }

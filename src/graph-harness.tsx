...
import { GraphComponent } from './shapes/GraphShape'
...
const shape = { id: 'shape:harness', type: 'graph', props: { doc: 'outline-proto', slug: 'proto', w: 440, h: 560 } }

createRoot(document.getElementById('host')!).render(
  <div style={{ width: 440, height: 560 }}>
    <GraphComponent shape={shape} />
  </div>
)

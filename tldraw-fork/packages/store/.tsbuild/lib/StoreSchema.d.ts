...
import { Migration, MigrationResult, MigrationSequence, SynchronousStorage } from './migrate';
 ...
 * @public
 */
export declare function upgradeSchema(schema: SerializedSchema): Result<SerializedSchemaV2, string>;
/**

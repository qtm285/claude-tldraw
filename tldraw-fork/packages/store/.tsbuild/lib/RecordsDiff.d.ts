 ...
 * @internal
 */
export declare function createEmptyRecordsDiff<R extends UnknownRecord>(): RecordsDiff<R>;
/**
...
/** @internal */
export declare function hasAnyKey(obj: object): boolean;
/**
 ...
 * @internal
 */
export declare function squashRecordDiffsMutable<T extends UnknownRecord>(target: RecordsDiff<T>, diffs: RecordsDiff<T>[]): void;
//# sourceMappingURL=RecordsDiff.d.ts.map
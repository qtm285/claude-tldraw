 ...
 * @internal
 */
export declare function getTlsyncProtocolVersion(): number;
/**
 ...
 */
export declare const TLIncompatibilityReason: {
 ...
 * @internal
 */
export type TLSocketClientSentEvent<R extends UnknownRecord> = TLPushRequest<R> | TLConnectRequest | TLPingRequest;

import { IndexKey, JsonValue, MakeUndefinedOptional } from '@tldraw/utils';
/**
...
export declare class Validator<T> implements Validatable<T> {
    ...
    readonly validateUsingKnownGoodVersionFn?: ValidatorUsingKnownGoodVersionFn<T, T> | undefined;
    /** @internal */
     ...
     */
    constructor(validationFn: ValidatorFn<T>, validateUsingKnownGoodVersionFn?: ValidatorUsingKnownGoodVersionFn<T, T> | undefined, 
    /** @internal */
 ...
 * @public
 */
export declare const nonZeroFiniteNumber: Validator<number>;
/**
 ...
 * @public
 */
export declare const unitInterval: Validator<number>;
/**
 ...
 * @internal
 */
export declare function numberUnion<Key extends string, Config extends UnionValidatorConfig<Key, Config>>(key: Key, config: Config): UnionValidator<Key, Config>;
/**
 ...
 * @public
 */
export declare const httpUrl: Validator<string>;
/**
 ...
 * @public
 */
export declare const indexKey: Validator<IndexKey>;
/**
 ...
 * @public
 */
export declare function or<T1, T2>(v1: Validatable<T1>, v2: Validatable<T2>): Validator<T1 | T2>;

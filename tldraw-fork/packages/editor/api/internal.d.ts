...
/** @internal */
export declare interface CanvasMaxSize {
    maxWidth: number;
    maxHeight: number;
    maxArea: number;
}
...
/** @internal */
export declare function clampToBrowserMaxCanvasSize(width: number, height: number): [number, number];
...
/** @internal */
export declare function getOwnerDocument(nodeOrDocument: Document | Node | null | undefined): Document;

/** @internal */
export declare function getOwnerWindow(nodeOrDocument: Document | Node | null | undefined): Window & typeof globalThis;
...
/** @internal */
export declare interface InvalidLicenseKeyResult {
    isLicenseParseable: false;
    reason: InvalidLicenseReason;
}

/** @internal */
export declare type InvalidLicenseReason = 'has-key-development-mode' | 'invalid-license-key' | 'no-key-provided';
 ...
 * @internal */
export declare function isAccelKey(e: {
    ctrlKey: boolean;
    metaKey: boolean;
}): boolean;
...
/** @internal */
export declare type LicenseFromKeyResult = InvalidLicenseKeyResult | ValidLicenseKeyResult;
...
/** @internal */
export declare type LicenseState = 'expired' | 'licensed-with-watermark' | 'licensed' | 'pending' | 'unlicensed-production' | 'unlicensed';
...
/** @internal */
export declare type StoreName = (typeof Table)[keyof typeof Table];
 ...
 * @internal
 */
export declare function useReactiveEvent<Args extends Array<unknown>, Result>(handler: (...args: Args) => Result): (...args: Args) => Result;
 ...
 * @internal
 */
export declare function useRefState<T>(initialValue: T): [T, Dispatch<SetStateAction<T>>];
...
/** @internal */
export declare function useShallowArrayIdentity<T extends null | readonly any[] | undefined>(arr: T): T;

/** @internal */
export declare function useShallowObjectIdentity<T extends null | object | undefined>(obj: T): T;
...
/** @internal */
export declare interface ValidLicenseKeyResult {

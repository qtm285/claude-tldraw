...
import { RecordProps, TLAsset, TLHandle, TLParentId, TLPropsMigrations, TLShape, TLShapeCrop, TLShapeId, TLShapePartial, TLUnknownShape, VecModel } from '@tldraw/tlschema';

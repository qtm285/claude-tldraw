...
import { getNotVisibleShapesForViewport, notVisibleShapes } from "./derivations/notVisibleShapes.mjs";
...
class Editor extends EventEmitter {
  ...
  /** @internal */
  _viewports = atom("viewports", /* @__PURE__ */ new Map());
  /** @public */
  ...
  /** @public */
  getViewport(id = DEFAULT_VIEWPORT_ID) {
    if (id === DEFAULT_VIEWPORT_ID) {
      return {
  ...
  screenToPage(point, opts) {
    const viewport = opts?.viewport || opts?.viewportId && opts.viewportId !== DEFAULT_VIEWPORT_ID ? this._resolveViewport(opts) : null;
    const screenBounds = viewport?.screenBounds ?? this.store.unsafeGetWithoutCapture(TLINSTANCE_ID).screenBounds;
  ...
  getCulledShapes(opts) {
    const isCustomViewport = opts?.viewport || opts?.viewportId && opts.viewportId !== DEFAULT_VIEWPORT_ID;
    ...
    const notVisibleShapes2 = viewport ? getNotVisibleShapesForViewport(this, viewport) : this.getNotVisibleShapes();
    const selectedShapeIds = this.getSelectedShapeIds();

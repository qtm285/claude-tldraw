import { Migration, MigrationId, MigrationSequence, StandaloneDependsOn, UnknownRecord } from '@tldraw/store';
 ...
 * @internal
 */
export declare function processPropsMigrations<R extends UnknownRecord & {
    type: string;
    props: object;
}>(typeName: R['typeName'], records: Record<string, SchemaPropsInfo>): MigrationSequence[];
/**
 ...
 * @internal
 */
export declare function createPropsMigration<R extends UnknownRecord & {
    type: string;
    props: object;
}>(typeName: R['typeName'], subType: R['type'], m: TLPropsMigration): Migration;
//# sourceMappingURL=recordsWithProps.d.ts.map
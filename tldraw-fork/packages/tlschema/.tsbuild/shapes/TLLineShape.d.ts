 ...
 * ```
 */
export declare const LineShapeSplineStyle: import("..").EnumStyleProp<"cubic" | "line">;
/**
...
export declare const lineShapeVersions: {
    readonly AddSnapHandles: "com.tldraw.shape.line/1";
    readonly RemoveExtraHandleProps: "com.tldraw.shape.line/2";
    readonly HandlesToPoints: "com.tldraw.shape.line/3";
    readonly PointIndexIds: "com.tldraw.shape.line/4";
    readonly AddScale: "com.tldraw.shape.line/5";
};
/**
 ...
 * @public
 */
export declare const lineShapeMigrations: import("..").TLPropsMigrations;

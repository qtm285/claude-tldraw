 ...
 * @public
 */
export declare const rootBindingVersions: {};
/**
 ...
 * @public
 */
export declare const rootBindingMigrations: import("@tldraw/store").MigrationSequence;
/**
 ...
 * @internal
 */
export declare function createBindingRecordType(bindings: Record<string, SchemaPropsInfo>): import("@tldraw/store").RecordType<{
    fromId: import("./TLShape").TLShapeId;
    id: TLBindingId;
    meta: import("@tldraw/utils").JsonObject;
    props: {
        [x: string]: /*elided*/ any;
    };
    toId: import("./TLShape").TLShapeId;
    type: string;
    typeName: "binding";
}, "fromId" | "props" | "toId" | "type">;
//# sourceMappingURL=TLBinding.d.ts.map
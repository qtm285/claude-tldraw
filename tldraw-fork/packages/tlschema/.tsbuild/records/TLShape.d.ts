...
export declare const rootShapeVersions: {
    readonly AddIsLocked: "com.tldraw.shape/1";
    readonly HoistOpacity: "com.tldraw.shape/2";
    readonly AddMeta: "com.tldraw.shape/3";
    readonly AddWhite: "com.tldraw.shape/4";
};
/**
 ...
 * @public
 */
export declare const rootShapeMigrations: import("@tldraw/store").MigrationSequence;
/**
 ...
 * @internal
 */
export declare function createShapeRecordType(shapes: Record<string, SchemaPropsInfo>): import("@tldraw/store").RecordType<{
    id: TLShapeId;

import { BaseRecord, RecordId, UnknownRecord } from '@tldraw/store';
...
export declare const documentVersions: {
    readonly AddName: "com.tldraw.document/1";
    readonly AddMeta: "com.tldraw.document/2";
};
/**
 ...
 * @public
 */
export declare const documentMigrations: import("@tldraw/store").MigrationSequence;
/**

 ...
 * @public
 */
export type TLThemeUiColorKeys = 'text' | 'background' | 'negativeSpace' | 'solid' | 'cursor' | 'noteBorder' | 'snap' | 'selectionStroke' | 'selectionFill' | 'brushFill' | 'brushStroke' | 'selectedContrast' | 'laser';
/**
 ...
 * @public
 */
export type TLThemeColors = Pick<TLThemeDefaultColors, TLThemeUiColorKeys> & Omit<TLThemeDefaultColors, TLThemeUiColorKeys | keyof TLRemovedDefaultThemeColors>;
/**
...
//# sourceMappingURL=TLTheme.d.ts.map
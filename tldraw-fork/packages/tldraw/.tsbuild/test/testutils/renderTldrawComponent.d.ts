 ...
 */
export declare function renderTldrawComponent(element: ReactElement, { waitForPatterns }: {
    waitForPatterns: boolean;
}): Promise<import("@testing-library/react").RenderResult<typeof import("@testing-library/dom/types/queries"), HTMLElement, HTMLElement>>;
export declare function renderTldrawComponentWithEditor(cb: (onMount: (editor: Editor) => void) => ReactElement, opts: {
    waitForPatterns: boolean;
}): Promise<{
    editor: Editor;
    rendered: import("@testing-library/react").RenderResult<typeof import("@testing-library/dom/types/queries"), HTMLElement, HTMLElement>;
}>;
//# sourceMappingURL=renderTldrawComponent.d.ts.map
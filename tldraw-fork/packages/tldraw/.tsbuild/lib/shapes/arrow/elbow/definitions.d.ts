import { Box, ElbowArrowSnap, Geometry2d, TLShapeId, Vec, VecLike } from '@tldraw/editor';
/**
...
export declare const ElbowArrowSides: readonly ["right", "bottom", "left", "top"];
/**
 ...
 */
export declare const ElbowArrowSideDeltas: {
    readonly top: {
        readonly x: 0;
        readonly y: -1;
    };
 ...
 */
export declare const ElbowArrowSideAxes: {
    readonly left: "x";
    readonly right: "x";
    readonly top: "y";
    readonly bottom: "y";
 ...
 */
export declare const ElbowArrowSideOpposites: {
    readonly top: "bottom";
    readonly right: "left";
    readonly bottom: "top";
    readonly left: "right";
};
export declare const ElbowArrowAxes: {
    readonly x: {
        readonly v: (x: number, y: number) => Vec;
        readonly loEdge: "left";
        readonly hiEdge: "right";
        readonly crossMid: "midY";
        readonly gap: "gapX";
        readonly midRange: "midXRange";
        readonly self: "x";
        readonly cross: "y";
        readonly size: "width";
    };
    readonly y: {
        readonly v: (y: number, x: number) => Vec;
        readonly loEdge: "top";
        readonly hiEdge: "bottom";
        readonly crossMid: "midX";
        readonly gap: "gapY";
        readonly midRange: "midYRange";
        readonly self: "y";
        readonly cross: "x";

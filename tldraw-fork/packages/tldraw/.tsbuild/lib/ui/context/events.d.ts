...
/** @internal */
export declare const EventsContext: React.Context<TLUiEventHandler | null>;
/** @public */
...
/** @public @react */
export declare function TldrawUiEventsProvider({ onEvent, children }: EventsProviderProps): import("react/jsx-runtime").JSX.Element;
/** @public */

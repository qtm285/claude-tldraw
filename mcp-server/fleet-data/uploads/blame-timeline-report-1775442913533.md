...
### Blame timeline — survival-draft (85 edits, 35 pages)
...
- **X-axis**: time (4/1–4/5)
- **Color**: author (legend shows "tlda" — shadow repo auto-commits all have this author; source repos with real git history show actual authors)

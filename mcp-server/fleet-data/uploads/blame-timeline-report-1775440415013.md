...
**Blame should be compiled-doc-focused, not file-by-file.** Y-axis should be position in the compiled document (page + line in rendered output), not source file lines. Use synctex/lookup data to map source diffs to their rendered positions in the document pages. Users think in terms of "page 3, paragraph 2 changed" not "appendix.tex line 147 changed."

**Not a fixed-size panel.** The blame timeline is a tldraw shape — resizable, movable, zoomable like everything else. No fixed overlays, no modal panels. It's a shape you place on the canvas.

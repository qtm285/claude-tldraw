...
\end{aligned}
\end{equation}
This is not the irreducible cost of matching. We can do better. The variance of any negligibly-biased estimator using deterministic integer weights $\tilde\theta_i$ is
\begin{equation}

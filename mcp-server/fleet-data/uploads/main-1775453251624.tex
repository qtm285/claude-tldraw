...
The AIPW bias decomposes into an inner product of the weight error $\dgamma = \hgamma - \gammaipw$ and the outcome error $\dm$, plus the imbalance in $\dm$ at the true weights:
\begin{equation}
